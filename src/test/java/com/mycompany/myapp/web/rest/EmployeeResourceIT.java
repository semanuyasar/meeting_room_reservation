...
class EmployeeResourceIT {
    ...
    public static Employee createEntity() {
        return new Employee().department(DEFAULT_DEPARTMENT);
    }
    ...
    public static Employee createUpdatedEntity() {
        return new Employee().department(UPDATED_DEPARTMENT);
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.department(UPDATED_DEPARTMENT);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.department(UPDATED_DEPARTMENT);
