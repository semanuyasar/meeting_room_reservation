...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="meetingroomreservationApp.employee.delete.question">
        <Translate contentKey="meetingroomreservationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
