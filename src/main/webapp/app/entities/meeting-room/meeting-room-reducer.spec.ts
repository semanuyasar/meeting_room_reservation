...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGROOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGROOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEETINGROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGROOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEETINGROOM actions', async () => {
      const arg = 42666;
